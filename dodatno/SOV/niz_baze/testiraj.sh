...
OUTP01=$(cat <<EOL
Unesite niz brojeva: 1 2 3 4 5 6 7
Unesite niz baza: 10 10 10 10 10 10 10
Rezultat: 1c
EOL
)
...
OUTP02=$(cat <<EOL
Unesite niz brojeva: f f f f f f f
Unesite niz baza: 16 16 16 16 16 16 16
Rezultat: 69
EOL
)
...
OUTP03=$(cat <<EOL
Unesite niz brojeva: ffffffffffffffff f
Unesite niz baza: 16 16
Doslo je do prekoracenja!
EOL
)
...
OUTP04=$(cat <<EOL
Unesite niz brojeva: 1010 1102
Unesite niz baza: 2 2
Unet je pogresan znak!
EOL
)
...
if [ "$1" != "" ] && [ -f "$1" ]; then
    ...
    gcc -g -m32 -o zad $1 $2 $3 $4 $5 1>$OUT1 2>&1
    if [ $? -ne 0 ]; then
